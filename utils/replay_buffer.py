...
class ReplayBufferMBPC(ReplayBuffer):
    """ replay buffer for model-based predictive control """
    def __init__(self, buffer_size, obs_shape, action_dim, plan_length, gamma):
        super(ReplayBufferMBPC, self).__init__(buffer_size, obs_shape, action_dim)
    ...
    def store(self, s, a, r, s_, done, timeout):
        ...
        super(ReplayBufferMBPC, self).store(s, a, r, s_, done, timeout)
